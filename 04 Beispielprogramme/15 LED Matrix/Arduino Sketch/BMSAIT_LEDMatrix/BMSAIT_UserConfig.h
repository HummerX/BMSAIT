...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_LEDMatrix"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
...
//DATA VARIABLES
  ...
  Datenfeld datenfeld[]=
  {
    //Description ID    DT    OT   TGT   REF2  REF3  REF4  REF5  IV
     {"RGear",  "1599", 'b',  12,   0,    1,    1,    0,    0,   "False"}     //Example Variable 0 - Right Gear Safe
    ,{"NGear",  "1597", 'b',  12,   0,    1,    2,    0,    0,   "False"}     //Example Variable 1 - Nose Gear Safe
    ,{"LGear",  "1598", 'b',  12,   0,    1,    3,    0,    0,   "False"}     //Example Variable 2 - Left Gear Safe
    ,{"UGear",  "1571", 'b',  12,   0,    2,    1,    0,    0,   "False"}     //Example Variable 3 - Gear Unsafe
  };  
