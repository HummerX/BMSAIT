...
//Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  const char ID[]= "BMSAIT_TM1637Demo";      
...
Datenfeld datenfeld[]=
  {
    //Description ID    DT   OT  PIN   C   SP  DP  IV
     {"Chaff",  "150", 'f',  31,   0,  2,  3,  0,  "00"}     //Example Variable 0 - Chaff remaining
    ,{"Flare",  "160", 'f',  31,   0,  2,  0,  0,  "00"}     //Example Variable 1 - Flare remaining
  };  
