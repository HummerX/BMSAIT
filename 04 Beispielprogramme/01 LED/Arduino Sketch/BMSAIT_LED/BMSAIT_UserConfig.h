...
Datenfeld datenfeld[]=
  {
    //Description ID    DT    OT  PIN   C   SP  DP  IV
     {"RGear",  "1599", 'b',  10,   2,  0,  0,  0,  "False"}     //Example Variable 0 - Right Gear Safe
    ,{"NGear",  "1597", 'b',  10,   3,  0,  0,  0,  "False"}     //Example Variable 1 - Nose Gear Safe
    ,{"LGear",  "1598", 'b',  10,   4,  0,  0,  0,  "False"}     //Example Variable 2 - Left Gear Safe
    ,{"UGear",  "1571", 'b',  10,   5,  0,  0,  0,  "False"}     //Example Variable 3 - Gear Unsafe
  };  
