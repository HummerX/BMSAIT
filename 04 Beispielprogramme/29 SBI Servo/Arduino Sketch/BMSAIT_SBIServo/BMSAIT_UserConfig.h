...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_SBI_Servo"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
      //Description ID      DT    OT    target Ref2  Ref3 Ref4 Ref5  RQ   IV
       ...
       ,{"SB",     "0201",  'i',  40,      0,   0,    1,   0,   0,   "", "0"}       //Variable 2 - Speedbrake position
    }; 
