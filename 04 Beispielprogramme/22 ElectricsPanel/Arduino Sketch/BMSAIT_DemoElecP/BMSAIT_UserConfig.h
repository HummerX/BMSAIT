...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_ElecPanel"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
     ...
     {"IFFC" ,    "0890", 's',  31,     0,    4,    0,  0,   0, "6666"}  //Variable 0 - IFF Code
    ,{"FLCS1",    "1587", 'b',  10,     12,   0,    0,  0,   0, "F"}    //Variable 1 - LED FLCS RDY
    ,{"FLCS2",    "1586", 'b',  10,     11,   0,    0,  0,   0, "F"}    //Variable 2 - LED TO FLCS
    ,{"FAIL" ,    "1588", 'b',  10,     10,   0,    0,  0,   0, "F"}    //Variable 3 - LED FAIL
    ,{"EPUPM",    "1585", 'b',  10,      9,   0,    0,  0,   0, "F"}    //Variable 4 - LED EPU PMG
    ,{"EPUGE",    "1584", 'b',  10,      8,   0,    0,  0,   0, "F"}    //Variable 5 - LED EPU GEN
    ,{"STBYG",    "1583", 'b',  10,      7,   0,    0,  0,   0, "F"}    //Variable 6 - STDBY GEN
    ,{"MAING",    "1582", 'b',  10,      6,   0,    0,  0,   0, "F"}    //Variable 7 - MAIN GEN
    ,{"FLCSP",    "1581", 'b',  10,      5,   0,    0,  0,   0, "F"}    //Variable 8 - FLCS PMG
    }; 
