...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_DemoLCD"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
...
Datenfeld datenfeld[]=
  {
   //Description ID      DT    OT    target Ref2 Ref3 Ref4 Ref5  IV
     {"FFLow",  "0510", 'f',    20,   0,    5,    11,  0,   0,  "0"}     //Example Variable 0 - FuelFlow
    ,{"FTot" ,  "0550", 'f',    20,   1,    5,    11,  0,   0,  "0"}     //Example Variable 1 - TotalFuel
    ,{"FFTxt",  "9999", 's',    20,   0,    10,    0,  0,   0,  "FuelFlow:  "}     //dummy variable to add a fixed text to the LCD display
    ,{"TFTxt",  "9999", 's',    20,   1,    10,    0,  0,   0,  "TotalFuel: "}     //dummy variable to add a fixed text to the LCD display
  };  
