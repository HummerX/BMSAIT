...
Datenfeld datenfeld[]=
  {
   ...
   {  "CHAFF",  "0150", 'f',  30,   0,  3,  0,  99, "123"}   //Variable 0 - Chaff Count
  ,{  "FLARE",  "0160", 'f',  30,   0,  3,  5,  99, "123"}   //Variable 1 - Flare Count
  ,{  "GO",     "1547", 'b',  10,  A4,  0,  0,   0, "1"}     //Variable 2 - GO Status
  ,{  "NOGO",   "1548", 'b',  10,  A5,  0,  0,   0, "1"}     //Variable 3 - NOGO Status
  ,{  "DEGR",   "1549", 'b',  10,  A3,  0,  0,   0, "1"}     //Variable 4 - DEGRADE Status
  ,{  "RDY",    "1549", 'b',  10,  A2,  0,  0,   0, "1"}     //Variable 5 - DISPENSER RDY Status
