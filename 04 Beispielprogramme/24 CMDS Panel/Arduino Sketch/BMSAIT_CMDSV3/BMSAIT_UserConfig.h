...
Datenfeld datenfeld[]=
  {
   ...
   {  "CHAFF",  "0150", 'f',  30,     0,      2,  6,  99,   0,  "12"}    //Variable 0 - Chaff Count
  ,{  "FLARE",  "0160", 'f',  30,     0,      2,  2,  99,   0,   "89"}    //Variable 1 - Flare Count
  ,{  "GO",     "1547", 'b',  10,    A4,      0,  0,   0,   0,   "F"}     //Variable 2 - GO Status
