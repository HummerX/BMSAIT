...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_CMDS_Demo"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
...
//DATA VARIABLES
  ...
  Datenfeld datenfeld[]=
  {
   ...
   {  "CHAFF",  "0150", 'f',  30,     0,    0,   2,   2,   99, "",  "12"}    //Variable 0 - Chaff Count
  ,{  "FLARE",  "0160", 'f',  30,     0,    0,   2,   6,   99, "",  "89"}    //Variable 1 - Flare Count
  ,{  "GO",     "1547", 'b',  10,    A3,    0,   0,   0,    0, "",  "F"}     //Variable 2 - GO Status
  ,{  "NOGO",   "1548", 'b',  10,    A2,    0,   0,   0,    0, "",  "F"}     //Variable 3 - NOGO Status
  ,{  "DEGR",   "1549", 'b',  10,    A4,    0,   0,   0,    0, "",  "F"}     //Variable 4 - DEGRADE Status
  ,{  "RDY",    "1549", 'b',  10,    A5,    0,   0,   0,    0, "",  "F"}     //Variable 5 - DISPENSER RDY Status
  ,{  "POWER",  "1243", 'b',  99,     0,    0,   0,   0,    0, "",  "T"}     //Variable 6 - Status of electrical system of the a/c
  ,{  "CHLOW",  "1551", 'b',  30,     0,    0,   2,   0,   99, "",  "T"}     //Variable 7 - Chaff Lo warning
  ,{  "FLLOW",  "1552", 'b',  30,     0,    0,   2,   4,   99, "",  "T"}     //Variable 8 - Flare Lo warning
  }; 
