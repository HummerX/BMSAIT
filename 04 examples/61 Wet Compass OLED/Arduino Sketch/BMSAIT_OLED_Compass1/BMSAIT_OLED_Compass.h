 // Display of the wet compass on a 128x64 OLED display
#include <U8g2lib.h>
...
/// Declare screen Object
    ...
    U8G2_SSD1306_128X64_NONAME_F_4W_SW_SPI displayOLED(U8G2_R2, /*d0*/2,/*d1*/ 3,/*CS*/ 6,/*DC*/ 5 ,/*Res*/4);
  #else
    //arduino board with low memory will have to use the buffered mode
    U8G2_SSD1306_128X64_NONAME_2_4W_SW_SPI displayOLED(U8G2_R2, /*d0*/2,/*d1*/ 3,/*CS*/ 6,/*DC*/ 5 ,/*Res*/4);
  #endif
...
///Layout settings
  ...
  #define OFFSETY 20        //increase this to move graphic      up      right     down      left
