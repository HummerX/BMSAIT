...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_OLED Compass"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
      //Description  ID      DT   OT    Tgt Ref2 Ref3 Ref4 Ref5  RQ IV
        {"Power",  "1241",  'b',  99,    0,   0,   0,   0,  0,   "", "T"}       //Variable 0 - Bus Power Battery
       ,{"CH",     "0750",  'f',  73,    0,   0,   0,   0,  0,   "", "0"}       //Variable 2 - Compass Heading
    }; 
