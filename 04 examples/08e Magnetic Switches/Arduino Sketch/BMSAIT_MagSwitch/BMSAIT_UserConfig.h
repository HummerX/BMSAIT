...
//BASIC SETTINGS
  ...
  #define PULLTIMEOUT 25      // set time to wait for a requested data update defaut: 30ms
  ...
  const char ID[]= "BMSAIT_MagSwitch"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
...
//DATA VARIABLES
  ...
  // 4. Output type (10-LED, 20-LCD, 30-MAX7219, 31-TM1637, 40-Servo, 41-ServoPWM, 50-Stepper 28BYJ, 51-Stepper X27-168, 52-StepperBoard VID6606, 60-MotorPoti, 7x-LCDs...)
  ...
  Datenfeld datenfeld[]=
    {
      //Description ID      DT    OT    target Ref2  Ref3 Ref4 Ref5  IV
        {"APMag",  "1531",  'b',  99,    0,   0,   0,   0,  0,   "", "F"}       //Variable 0 - magSwitch Autopilot
/*     ,{"JFSMg",  "1247",  'b',  99,    0,   0,   0,   0,  0,   "", "F"}       //Variable 1 - magSwitch JFS
       ,{"PBMag",  "1600",  'b',  99,    0,   0,   0,   0,  0,   "", "F"}       //Variable 2 - magSwitch Parking brake
       ,{"BITMg",  "1594",  'b',  99,    0,   0,   0,   0,  0,   "", "F"}       //Variable 3 - LED BitTest run (there's no dedicated bit for mag switch)*/
    }; 
