...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_Backlight"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
      //Description ID    DT    OT    target Ref2 Ref3 Ref4 Ref5  RQ   IV
       ...
       ,{"Light",  "0880", 'b',  80,    10,    0,   0,   0,   0,   "",  "0"}       //Variable 1 - Inst backlight brightness
    }; 
