...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_DemoMax7219"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
      //Description ID    DT    OT    target Ref2  Ref3  Ref4   Ref5   RQ  IV
       {"BUHFF",  "1120", 's',  30,     0,    0,    4,    4,     2,   ""   "1234"}     //Example Variable 0 - Backup UHF Frequency   //Example Variable 0 - Right Eyebrow Engine Fire
    }; 
