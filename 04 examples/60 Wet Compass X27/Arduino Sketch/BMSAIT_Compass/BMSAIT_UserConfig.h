...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_Compass"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
      //Description ID    DT    OT    target Ref2 Ref3 Ref4 Ref5  RQ   IV
        {"PWR",    "1243", 'b',  99,    0,     0,   0,   0,   0,   "",  "T"}       //Variable 0 - Power status
       ,{"HDG",    "0751", 'i',  53,    0,     0,   0,   0,   0,   "",  "0"}       //Variable 1 - Heading (0..65535)
       ,{"Light",  "0880", 'b',  80,    10,    0,   0,   0,   0,   "",  "0"}       //Variable 2 - Inst backlight brightness
    }; 
