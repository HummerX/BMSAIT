...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_DemoOLED"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
      //Description ID      DT    OT   Ref1 Ref2 Ref3 Ref4 Ref5  RQ   IV
       {"In3D",   "1651",  'b',  99,    0,   0,   0,   0,  0,   "",   "T"}          //Variable 1 - Player is in 3D
      ,{"FQty",   "0551",  's',  70,    0,   0,   0,   0,  0,   "",   "00000"}      //Variable 0 - Fuel Quantity Total
    }; 
