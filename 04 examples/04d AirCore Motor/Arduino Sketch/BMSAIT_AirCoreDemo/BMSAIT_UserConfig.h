...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_AirCoreTest"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
      //Description ID    DT    OT    target Ref2 Ref3 Ref4 Ref5  RQ   IV
       {"RPM",    "0341", 'i',  54,    0,     0,   0,   0,   0,   "",  "0"}     //Example Variable 0 - RPM gauge
    }; 
