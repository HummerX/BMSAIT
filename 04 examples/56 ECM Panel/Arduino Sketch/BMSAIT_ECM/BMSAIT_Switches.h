...
typedef struct //data field structure for switches and buttons
{
  ...
  char signalOn[3];               //sets the command that will be send to the windows app when the switch is activated
  char signalOff[3];              //sets the command that will be send to the windows app when the switch is deactivated
...
Switch switches[]=
{
 // <PIN>,<description>,<type>,<rotarySwitchID>,  0, <commandID when pressed>,<commandID when released>,<internal command> 
     {5,     "OPER",      2,           0,         0,          "01",                     "02",                  0}   // ECM ON/OFF
    ,{6,     "XMT3",      2,           0,         0,          "04",                     "05",                  0}   // XMIT 2/3
    ,{7,     "XMT1",      2,           0,         0,          "06",                     "05",                  0}   // XMIT 1/2
    ,{8,     "BIT",       1,           0,         0,          "03",                     "00",                  0}   // ECM BIT Test
    ,{A0,     "M1",       1,           0,         0,          "07",                     "00",                  0}   // ECM Mode 1
    ,{A1,     "M2",       1,           0,         0,          "08",                     "00",                  0}   // ECM Mode 2
    ,{A2,     "M3",       1,           0,         0,          "09",                     "00",                  0}   // ECM Mode 3
    ,{A3,     "M4",       1,           0,         0,          "10",                     "00",                  0}   // ECM Mode 4
    ,{A4,     "M5",       1,           0,         0,          "11",                     "00",                  0}   // ECM Mode 5
};
